...
> Long-Context F1 的 **97.7%**（原版为 85.1%）。
...
| trpc-agent-go (原版) | 0.399 | 6,068,802 | 3,056 | 65.7 |
...
> 2,839 tokens/QA 达到 0.427 的 F1。原版排第三（65.7），以
> 3,056 tokens/QA 达到 0.399 的 F1。优化版以 17,359 tokens/QA
...
尽管 token 成本更高，优化版的 F1/成本权衡显著更优：以 **5.7 倍 token
成本**换取 **+14.8% F1 提升**（0.399→0.458），在重视回答质量的生产
场景中是值得的。
