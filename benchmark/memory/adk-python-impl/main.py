...
# Constants.
# ---------------------------------------------------------------------------
NOT_AVAILABLE = "The information is not available in my memory."
...
_QA_SYSTEM_PROMPT = """\
You are a memory assistant. When asked a question, use the \
load_memory tool to search your memory for relevant information, \
