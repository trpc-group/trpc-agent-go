	...
	return function.NewFunctionTool(
		...
		function.WithInputSchema(&tool.Schema{
			...
			Properties: map[string]*tool.Schema{
				"length":            {Type: "integer", Description: "Length of password to generate (8-64)"},
				"include_numbers":   {Type: "boolean", Description: "Include numbers in password", Default: true},
				"include_symbols":   {Type: "boolean", Description: "Include symbols in password", Default: true},
				"include_uppercase": {Type: "boolean", Description: "Include uppercase letters", Default: true},
				"include_lowercase": {Type: "boolean", Description: "Include lowercase letters", Default: true},
			},
		}),
	)
}
