...
func brandLandingPrompt() string {
	return strings.Join([]string{
		...
		"",
		"Please use these skills:",
		"- brand-guidelines (produce a tokens JSON)",
		"- frontend-design (build a small HTML+CSS site)",
		"",
		"Deliverables (exact paths):",
		"- " + fileBrandTokens,
		...
		"- Using brand-guidelines, extract the official hex codes from",
		"  SKILL.md (do not invent colors).",
		"- Using brand-guidelines, write " + fileBrandTokens + " and",
		"  write " + fileBrandStylesCSS + " with :root CSS variables",
		"  containing literal hex values (no JS token loading).",
		"- Using frontend-design, create " + fileBrandIndexHTML +
			" and use the variables from styles.css.",
