...
func (p *WorkspaceExecRequestProcessor) guidanceText(
	...
	b.WriteString("fallback tool when no specialized tool is available ")
	b.WriteString("or sufficient, or when the task depends on the ")
	...
	b.WriteString("or when specialized tools are unavailable or ")
	b.WriteString("insufficient.\n")
