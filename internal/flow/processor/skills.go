...
func defaultFullToolingAndWorkspaceGuidance(
	...
	b.WriteString("- When you need a skill's instructions or bundled ")
	b.WriteString("resources, start with skill_load for SKILL.md, then ")
	b.WriteString("load only the docs you still need.\n")
