...
func defaultToolingAndWorkspaceGuidance() string {
	...
	b.WriteString("- When skill_run returns output_files, prefer ")
	b.WriteString("using the returned output_files content directly. ")
	b.WriteString("Do not call read_document or file tools to read ")
	b.WriteString("those paths; they are workspace-relative.\n")
