...
func DirectRunErrorKindOf(err error) DirectRunErrorKind {
	switch {
	case errors.Is(err, sessionrevision.ErrLatestTurnReplacementUnsupported):
		return DirectRunErrorLatestTurnReplacementUnsupported
	case errors.Is(err, sessionrevision.ErrLatestTurnReplacementConflict):
		return DirectRunErrorLatestTurnReplacementConflict
	case errors.Is(err, sessionrevision.ErrLatestTurnReplacementUnavailable):
...
func (k DirectRunErrorKind) Sentinel() error {
	...
	case DirectRunErrorLatestTurnReplacementUnsupported:
		return sessionrevision.ErrLatestTurnReplacementUnsupported
	case DirectRunErrorLatestTurnReplacementConflict:
		return sessionrevision.ErrLatestTurnReplacementConflict
