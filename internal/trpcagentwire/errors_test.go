...
func TestDirectRunErrorKinds(t *testing.T) {
	tests := []struct {
		...
		{
			name: "unsupported",
			err:  sessionrevision.ErrLatestTurnReplacementUnsupported,
			kind: DirectRunErrorLatestTurnReplacementUnsupported,
		},
		{
			name: "conflict",
			err:  sessionrevision.ErrLatestTurnReplacementConflict,
			kind: DirectRunErrorLatestTurnReplacementConflict,
		},
		{
			name: "unavailable",
			err:  sessionrevision.ErrLatestTurnReplacementUnavailable,
