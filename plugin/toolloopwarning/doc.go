...
// model response selects the same ordered tool bundle, the plugin returns an
// agent.StopError before any of those tools execute. The stop diagnostic
// contains only the bounded action fingerprint, not tool arguments or results.
