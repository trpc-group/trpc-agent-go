...
const (
	reviewerUserIDPrefix    = "unsafeintent-reviewer-user:"
	reviewerSessionIDPrefix = "unsafeintent-reviewer-session:"
)

// Option configures the built-in unsafe intent reviewer.
