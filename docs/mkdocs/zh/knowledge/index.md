...
我们使用 [RAGAS](https://docs.ragas.io/) 框架对 tRPC-Agent-Go、LangChain 和 Agno 进行了全面的 RAG 质量评测。
...
- **对比对象**: tRPC-Agent-Go vs LangChain vs Agno，使用相同的配置参数

### 配置对齐

为确保公平对比，三个系统使用完全相同的配置：
