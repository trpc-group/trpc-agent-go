...
llmAgent := llmagent.New(
    ...
    llmagent.WithMessageTimelineFilterMode(llmagent.BranchFilterModeAll),                                      // Set message timeline filter mode, Options：all、request、invocation, default: all
    llmagent.WithMessageBranchFilterMode(llmagent.TimelineFilterAll),                                     // Set message branch filter mode, Options: all、prefix、exact, default: prefix
)
```
