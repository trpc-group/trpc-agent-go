...
- **🛡️ Tool Safety Guard**: See [Tool Safety Guard](tool-safety.md) for configurable pre-execution scanning, permission interception, audit JSONL, and `tool.safety.*` telemetry attributes.
