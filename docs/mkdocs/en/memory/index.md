...
Choose a backend-specific guide for configuration details. Shared Agent
integration, extraction modes, and tool behavior are covered in
...
ACID Requirements → SQLite/SQLiteVec/MySQL/PostgreSQL (transaction guarantees)
