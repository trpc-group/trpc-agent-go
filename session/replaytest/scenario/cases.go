...
var Case06_Summary = &Case{
	...
	Ops: []Op{
		{Kind: OpCreateSession},
		{
			Kind: OpAppendEvent, EventID: "case06-u1",
			Timestamp: replayBaseTime, Role: "user", Content: "用户喜欢简洁中文回答",
		},
		{
			Kind: OpAppendEvent, EventID: "case06-a1",
			Timestamp: replayBaseTime.Add(time.Second), Role: "assistant", Content: "好的，后续会尽量简洁。",
		},
		{Kind: OpUpdateSummary, FilterKey: "", Force: true},
		{
			Kind: OpAppendEvent, EventID: "case06-u2",
			Timestamp: replayBaseTime.Add(2 * time.Second), Role: "user", Content: "请继续保持简洁",
		},
		{
			Kind: OpAppendEvent, EventID: "case06-a2",
			Timestamp: replayBaseTime.Add(3 * time.Second), Role: "assistant", Content: "好的。",
		},
		{Kind: OpUpdateSummary, FilterKey: "", Force: true},
	},
}
