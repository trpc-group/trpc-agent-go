...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/memory/clickhouse v0.0.0-00010101000000-000000000000
...
replace trpc.group/trpc-go/trpc-agent-go/memory/clickhouse => ../../memory/clickhouse

replace trpc.group/trpc-go/trpc-agent-go/memory/mysql => ../../memory/mysql

replace trpc.group/trpc-go/trpc-agent-go/session/clickhouse => ../clickhouse
