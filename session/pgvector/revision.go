...
func (s *Service) revisionStore() sqlrevision.Store {
	return sqlrevision.Store{
		...
		PreserveSummaryHistory: s.opts.softDelete,
...
// Rewind atomically restores a retained pre-request session boundary while
// preserving embeddings for prefix events.
