...
func (m *MockService) GetSummaryRecord(ctx context.Context, sess *Session) (*SummaryRecord, bool) {
	return nil, false
}

func (m *MockService) SaveSummaryRecord(ctx context.Context, sess *Session, rec *SummaryRecord) error {
	return nil
}
