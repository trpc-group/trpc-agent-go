...
// This file pins the failure paths of directory staging, batched
// upload, and the bash helpers: every remote call (CreateDirectory,
// UploadFiles, runBash) is made to fail in turn and the test asserts
// the error surfaces instead of a partial upload being reported as
// success. Happy paths live in workspace_runtime_test.go.
