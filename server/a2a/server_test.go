...
func (m *mockEventToA2AConverter) ConvertToA2AMessage(ctx context.Context, ctxID string, event *event.Event) (protocol.UnaryMessageResult, error) {
...
func (m *mockEventToA2AConverter) ConvertStreamingToA2AMessage(ctx context.Context, taskID string, ctxID string, event *event.Event) (protocol.StreamingMessageResult, error) {
	return &protocol.Message{
		Role:  protocol.MessageRoleAgent,
