...
// AddMemoryWithEpisodic delegates to AddMemory (episodic fields ignored for mysql backend).
...
// UpdateMemoryWithEpisodic delegates to UpdateMemory (episodic fields ignored for mysql backend).
