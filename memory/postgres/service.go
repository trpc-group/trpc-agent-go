...
// AddMemoryWithEpisodic delegates to AddMemory (episodic fields ignored for postgres backend).
...
// UpdateMemoryWithEpisodic delegates to UpdateMemory (episodic fields ignored for postgres backend).
...
// SearchMemoriesWithOptions delegates to SearchMemories (advanced filtering ignored for postgres backend).
