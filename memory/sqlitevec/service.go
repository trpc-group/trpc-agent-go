...
// AddMemoryWithEpisodic delegates to AddMemory (episodic fields ignored for sqlitevec backend).
...
// UpdateMemoryWithEpisodic delegates to UpdateMemory (episodic fields ignored for sqlitevec backend).
