...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/memory/mysql v1.10.0 // indirect
	trpc.group/trpc-go/trpc-agent-go/memory/postgres v1.10.0 // indirect
	trpc.group/trpc-go/trpc-agent-go/memory/redis v1.10.0 // indirect
	trpc.group/trpc-go/trpc-agent-go/memory/sqlite v1.10.0 // indirect
	trpc.group/trpc-go/trpc-agent-go/session/clickhouse v1.10.0 // indirect
	trpc.group/trpc-go/trpc-agent-go/session/mysql v1.10.0 // indirect
	trpc.group/trpc-go/trpc-agent-go/session/postgres v1.10.0 // indirect
	trpc.group/trpc-go/trpc-agent-go/session/redis v1.10.0 // indirect
	trpc.group/trpc-go/trpc-agent-go/session/sqlite v1.10.0 // indirect
