...
// Package rubriccritic evaluates agent outputs with a failure-oriented rubric LLM judge.
...
type rubricCriticEvaluator struct {
...
// New builds the rubric critic evaluator.
func New(opt ...Option) evaluator.Evaluator {
	opts := newOptions(opt...)
	e := &rubricCriticEvaluator{
...
func (e *rubricCriticEvaluator) Name() string {
	return "llm_rubric_critic"
}

// Description returns the description of the evaluator.
func (e *rubricCriticEvaluator) Description() string {
	return "LLM rubric critic evaluator"
}

// Evaluate evaluates the response of the agent with a critic-style rubric judge.
func (e *rubricCriticEvaluator) Evaluate(ctx context.Context, actuals, expecteds []*evalset.Invocation,
...
func (e *rubricCriticEvaluator) ConstructMessages(ctx context.Context, actuals, expecteds []*evalset.Invocation,
...
func (e *rubricCriticEvaluator) AggregateSamples(ctx context.Context, samples []*evaluator.PerInvocationResult,
...
func (e *rubricCriticEvaluator) AggregateInvocations(ctx context.Context, results []*evaluator.PerInvocationResult,
	evalMetric *metric.EvalMetric) (*evaluator.EvaluateResult, error) {
