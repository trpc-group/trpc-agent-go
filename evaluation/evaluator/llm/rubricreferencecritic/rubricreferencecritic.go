...
// Package rubricreferencecritic evaluates agent outputs against reference answers using rubric-based LLM judges.
...
type rubricReferenceCriticEvaluator struct {
...
const (
	evaluatorName = "llm_rubric_reference_critic"
)

// New builds the reference-aware rubric critic evaluator.
func New(opt ...Option) evaluator.Evaluator {
	opts := newOptions(opt...)
	e := &rubricReferenceCriticEvaluator{
...
func (e *rubricReferenceCriticEvaluator) Name() string {
	return evaluatorName
}

// Description returns the description of the evaluator.
func (e *rubricReferenceCriticEvaluator) Description() string {
	return "LLM rubric critic evaluator against reference answers"
}

// Evaluate evaluates the response of the agent against reference answers.
func (e *rubricReferenceCriticEvaluator) Evaluate(ctx context.Context, actuals, expecteds []*evalset.Invocation,
...
func (e *rubricReferenceCriticEvaluator) ConstructMessages(ctx context.Context, actuals, expecteds []*evalset.Invocation,
...
func (e *rubricReferenceCriticEvaluator) AggregateSamples(ctx context.Context, samples []*evaluator.PerInvocationResult,
...
func (e *rubricReferenceCriticEvaluator) AggregateInvocations(ctx context.Context, results []*evaluator.PerInvocationResult,
	evalMetric *metric.EvalMetric) (*evaluator.EvaluateResult, error) {
