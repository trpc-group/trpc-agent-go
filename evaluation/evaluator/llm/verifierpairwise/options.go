...
import (
	...
	vmessagesconstructor "trpc.group/trpc-go/trpc-agent-go/evaluation/evaluator/llm/operator/messagesconstructor/verifierpairwise"
	"trpc.group/trpc-go/trpc-agent-go/evaluation/evaluator/llm/operator/responsescorer"
	vresponsescorer "trpc.group/trpc-go/trpc-agent-go/evaluation/evaluator/llm/operator/responsescorer/verifierpairwise"
...
func newOptions(opt ...Option) *options {
	opts := &options{
		messagesConstructor:   vmessagesconstructor.New(),
		responsescorer:        vresponsescorer.New(),
...
// Option customizes Verifier evaluator dependencies.
type Option func(*options)

// WithMessagesConstructor sets the prompt builder for pairwise verifier evaluation.
