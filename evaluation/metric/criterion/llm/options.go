...
type options struct {
	...
	sampleParallelismEnabled bool                    // sampleParallelismEnabled enables concurrent sample requests.
...
// WithSampleParallelismEnabled enables or disables concurrent judge sample requests.
func WithSampleParallelismEnabled(enabled bool) Option {
	return func(o *options) {
		o.sampleParallelismEnabled = enabled
	}
}
