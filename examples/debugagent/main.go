...
func main() {
	...
	fmt.Printf("Available tools: save_file, read_file, read_many_files, list_file, search_file, search_content, replace_content\n")
...
func (c *debugChat) setup(ctx context.Context) error {
	...
	instruction := strings.Join([]string{
		...
		"- read_many_files: Prefer this when you need multiple files in one call to reduce round-trips.",
		...
		"- read_many_files: Read multiple files in a single call.",
