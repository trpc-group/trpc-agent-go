...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/session/mongodb v0.0.0-00010101000000-000000000000
...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/storage/mongodb v0.0.0-00010101000000-000000000000 // indirect
