module trpc.group/trpc-go/trpc-agent-go/examples/graph_debugserver
...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/server/debug v0.5.0
)
...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/evaluation v0.0.0-20251126064502-c8c2594d2519 // indirect
)
