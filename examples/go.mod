...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/codeexecutor/jupyter v0.0.0-20251111082011-79f521f76893
	trpc.group/trpc-go/trpc-agent-go/tool/openapi v0.0.0-00010101000000-000000000000
