...
`http://localhost:8000`. An explicit `CHROMA_URL` always takes precedence.
The collection defaults to `trpc_example`; the `chroma.New` API itself does
not default to any base URL.
