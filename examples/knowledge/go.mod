...
require (
	...
	trpc.group/trpc-go/trpc-agent-go/knowledge/document/reader/pdf v0.0.0
	trpc.group/trpc-go/trpc-agent-go/knowledge/embedder/gemini v0.0.0
	trpc.group/trpc-go/trpc-agent-go/knowledge/vectorstore/elasticsearch v0.0.0-20250904083407-47793751230e
