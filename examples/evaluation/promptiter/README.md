...
This directory contains six PromptIter examples and links to the related regression-loop example:
...
- [promptiter_regression_loop](../promptiter_regression_loop): combines Evaluation Service, failure attribution, PromptIter proposals, validation regression gates, and atomic audit reports in a deterministic example that needs no API key.
