...
- [regressionloop](./regressionloop): wraps PromptIter-compatible instruction patches in a deterministic train/validation regression loop with failure attribution, overfit and budget gates, and JSON/Markdown audit reports.
