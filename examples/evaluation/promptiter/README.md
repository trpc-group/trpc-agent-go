...
- [regressionloop](./regressionloop): connects PromptIter training to an independent held-out release gate with deterministic and live modes, cumulative resource budgets, and immutable audit bundles.
