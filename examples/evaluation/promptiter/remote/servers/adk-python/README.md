...
This example exposes a Google ADK `LlmAgent` through the `server/trpcagent` HTTP protocol so PromptIter can optimize its `candidate#instruction` surface remotely.
