...
The tests cover attribution precedence, negated-fact counterexamples, paired deltas, Pass^k, bootstrap reproducibility, hard-failure and critical-case vetoes, overfitting rejection, configuration inheritance, HTTP retry accounting, optimizer and global budgets, validation-capacity reservation, validation-set leakage, fail-closed live reports, atomic report replacement, and end-to-end deterministic replay.
