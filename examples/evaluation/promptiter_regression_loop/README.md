...
The tests cover attribution precedence, equivalent negations, natural-language credential-disclosure counterexamples, paired deltas, Pass^k, bootstrap reproducibility, retained and new hard-failure vetoes, critical-case protection, provider-error rejection, overfitting rejection, strict configuration decoding, optimizer-identifier enforcement, seed consistency, configuration inheritance, HTTP retry accounting, optimizer and global budgets, validation-capacity reservation, validation-set leakage, fail-closed live reports, atomic report replacement, and end-to-end deterministic replay.
