...
- 分数变化: -0.2500
- 是否接受: false
- 门禁理由: candidate validation score regressed below baseline
- 拒绝原因: validation_regression
...
本次优化候选在验证集上得分为 0.0000（基线 0.2500，变化 -0.2500），gate 决策为已拒绝。拒绝理由：candidate validation score regressed below baseline（validation_regression）。 全部 16 个失败均集中在 response_mismatch。
...
| --- | --- | --- | --- | --- |
| 1 | 0.2500 | 0.0000 | false | candidate score gain does not satisfy acceptance policy |
| 2 | 0.2500 | 0.0000 | false | candidate score gain does not satisfy acceptance policy |
| 3 | 0.2500 | 0.0000 | false | candidate score gain does not satisfy acceptance policy |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| nba-commentary-validation | validation_03_f1_rain_safety_car | 0.2500 | 0.0000 | false | false | -0.2500 | 下降 | 分数下降 |
| nba-commentary-validation | validation_05_ice_hockey_overtime | 0.2500 | 0.0000 | false | false | -0.2500 | 下降 | 分数下降 |
| nba-commentary-validation | validation_06_tennis_tiebreak | 0.2500 | 0.0000 | false | false | -0.2500 | 下降 | 分数下降 |
| nba-commentary-validation | validation_08_cricket_t20_chase | 0.2500 | 0.0000 | false | false | -0.2500 | 下降 | 分数下降 |
| nba-commentary-validation | validation_02_football_penalties | 0.2500 | 0.0000 | false | false | -0.2500 | 下降 | 分数下降 |
| nba-commentary-validation | validation_04_badminton_match_point | 0.2500 | 0.0000 | false | false | -0.2500 | 下降 | 分数下降 |
| nba-commentary-validation | validation_07_road_cycling_breakaway | 0.2500 | 0.0000 | false | false | -0.2500 | 下降 | 分数下降 |
| nba-commentary-validation | validation_01_nba_empty_48 | 0.2500 | 0.0000 | false | false | -0.2500 | 下降 | 分数下降 |
...
- Fake 模式：true（场景=regression）

## 候选 Prompt

```text
你是一名体育评论员。请用极简一句话概括比赛，不要展开任何细节。
```
