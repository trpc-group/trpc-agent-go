module trpc.group/trpc-go/trpc-agent-go/examples/evaluation/promptiter_regression_loop
...
require trpc.group/trpc-go/trpc-agent-go/evaluation v0.0.0-00010101000000-000000000000
...
require (
	...
	trpc.group/trpc-go/trpc-agent-go v0.8.0 // indirect
