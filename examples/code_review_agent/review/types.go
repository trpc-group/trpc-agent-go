...
const (
	// StatusRunning identifies an in-progress review task.
	StatusRunning = "running"
	// StatusCompleted identifies a successfully completed review task.
	StatusCompleted = "completed"
	// StatusFailed identifies a failed review task.
	StatusFailed = "failed"

	// InputTypeDiffFile identifies unified diff file input.
	InputTypeDiffFile = "diff_file"
	// InputTypeRepoPath identifies repository working-tree input.
	InputTypeRepoPath = "repo_path"
	// InputTypeFixture identifies bundled fixture input.
	InputTypeFixture = "fixture"
	// InputTypeFiles identifies explicit file-list input.
	InputTypeFiles = "files"

	// SeverityCritical identifies findings requiring immediate remediation.
	SeverityCritical = "critical"
	// SeverityHigh identifies findings with high impact.
	SeverityHigh = "high"
	// SeverityMedium identifies findings with moderate impact.
	SeverityMedium = "medium"
	// SeverityLow identifies findings with low impact.
	SeverityLow = "low"
)
...
const (
	...
	// FilterStageConfidence identifies confidence-based routing.
	FilterStageConfidence = "confidence"

	// FilterDecisionKeep records that a finding was retained.
	FilterDecisionKeep = "keep"
	// FilterDecisionHumanReview routes a finding to human review.
	FilterDecisionHumanReview = "needs_human_review"
	// FilterDecisionWarning routes a finding to warnings.
	FilterDecisionWarning = "warning"
	// FilterDecisionDropDuplicate records duplicate suppression.
