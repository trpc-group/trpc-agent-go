...
func main() {
	var (
		...
		enableTest   = flag.Bool("enable-go-test", false, "schedule run_go_test.sh when --repo-path is set")
		enableStatic = flag.Bool("enable-staticcheck", false, "schedule run_staticcheck.sh when --repo-path is set")
