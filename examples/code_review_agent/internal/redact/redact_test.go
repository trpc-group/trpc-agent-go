...
func TestSanitizerDetectsSupportedCredentialFormats(t *testing.T) {
	tests := []struct {
		...
		{name: "GitLab token", input: "gl" + "pat-abcdefghijklmnopqrstuvwxyz1234", plaintext: "gl" + "pat-abcdefghijklmnopqrstuvwxyz1234", ruleID: "SECRET-GITLAB"},
		...
		{name: "MongoDB URL password", input: "mongo" + "db+srv://user:mongo-password@db.example/app", plaintext: "mongo-" + "password", ruleID: "SECRET-URL-USERINFO"},
