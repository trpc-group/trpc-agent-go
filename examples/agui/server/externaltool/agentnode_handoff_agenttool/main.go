...
// Package main demonstrates AgentNode handoff to AgentTool-wrapped GraphAgents in an AG-UI server.
package main
...
import (
	...
	handoffagent "trpc.group/trpc-go/trpc-agent-go/examples/agui/server/externaltool/agentnode_handoff_agenttool/agent"
...
const (
	appName = "agui-agentnode-handoff-agenttool-demo"
)
...
func main() {
	...
	ga, err := handoffagent.NewGraphAgent(checkpointSaver, modelInstance, generationConfig)
	if err != nil {
